...
def align_symptoms_with_timestamps_detalhado(sintomas, target_labels):
    """
    Alinha sintomas com os horários-alvo, retornando o sintoma mais intenso por horário.
    """
    resultado = []
...
def painel():
    ...
    # Sintomas históricos (últimas 6 medições)
