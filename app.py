...
import os
import threading
import asyncio # NOVO: Importar asyncio
import paho.mqtt.client as mqtt
from flask import Flask, jsonify

# ===== REGISTRO DAS ROTAS (BLUEPRINTS) =====
from routes.painel import painel_bp
from routes.sensores import sensores_bp, salvar_dados_db # IMPORTAMOS a função de salvar
from routes.chat import chat_bp
from routes.insights import insights_bp
from routes.configuracoes import configuracoes_bp

# ===== MÓDULOS DE BACKGROUND =====
# Corrija os caminhos de importação para a raiz do projeto
...
if __name__ == '__main__':
    ...
    # --- Thread do monitor de sensores (oxímetro, etc.) ---
    # MODIFICADO: Usamos a função wrapper para lidar com o asyncio
    ...
    # NOVO: Passamos o estado central e o lock para a função
    db_saver_thread = threading.Thread(
        target=salvar_dados_db,
        args=(app_state, state_lock), # Passando o estado como argumento
        daemon=True
    )
